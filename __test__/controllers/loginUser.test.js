...
import { loginUser } from "../../src/api/controllers/auth";
...
describe("POST /api/auth/login", () => {
    ...
    it('should return a successful login response', async () => {
        ...
        require('../../src/api/models/').User.findOne.mockResolvedValue(mockUser);
        ...
        const response = res
        console.log(req, response.statusCode, response);
